    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                    ...
                    <div class="bg-yellow-100 border-b-4 border-yellow-600 rounded-lg shadow-lg p-5">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                ...
                                <?php
                                        $sql = "SELECT COUNT(*) as subjects_count FROM subject";
            ...
            <div class="flex flex-row flex-wrap flex-grow mt-2">
                <?php 
                    $sql = "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' AND TABLE_SCHEMA='bunkmgr'";
            ...
            <table class="text-left w-full border-collapse"> <!--Border collapse doesn't work on this site yet but it's available in newer tailwind versions -->
              ...
              <tbody>
                ...
                while($row = mysqli_fetch_assoc($res)){
                    ...
                    $r .= '</td>
                        <td class="py-4 px-6 border-b border-grey-light">
                        <a href="subjects-dashboard.php?name=';
                    $r .= $name; 
